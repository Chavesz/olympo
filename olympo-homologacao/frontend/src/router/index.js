...
import AdminAlunos from '../views/admin/Alunos.vue'
import AdminInstrutores from '../views/admin/Instrutores.vue'
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'alunos', name: 'admin-alunos', component: AdminAlunos },
      { path: 'instrutores', name: 'admin-instrutores', component: AdminInstrutores },
    ],
  },
]
