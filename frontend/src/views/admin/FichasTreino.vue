...
<template>
  <section class="space-y-6">
    <header class="space-y-1">
      ...
      <p class="text-sm text-slate-700">CRUD de fichas (dados mockados).</p>
    </header>
        ...
        <table class="min-w-full text-left text-sm">
          ...
          <tbody class="divide-y divide-slate-200">
            ...
            <tr v-if="filteredFichas.length === 0">
              <td class="px-4 py-8 text-center text-sm text-slate-700" colspan="7">
            ...
            <div class="mt-4 space-y-3">
              ...
              <label class="block space-y-1">
                ...
                <textarea
                  ...
                  class="min-h-32 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none ring-slate-400 focus:ring-2"
